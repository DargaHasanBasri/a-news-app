...
class CustomColors {
  ...
  static Color whiteSmoke = const Color(0xffF6F6F6);
  static Color osloGrey = const Color(0xff8A8C8B);
  static Color pastelGrey = const Color(0xffCACACB);
  static Color coolBlue = const Color(0xff4D7CD7);
  static Color darkMidnightBlue = const Color(0xff012466);
  ...
  static Color textGrey = const Color(0xffB8B8BA);
