...
import 'package:a_news_app/utils/extensions.dart';
...
class WeatherType {
  ...
  String getIconAddress(WeatherTypeEnum? weatherEnum, String? time) {
    DateTime timeDate = Extensions.getDateTime(time);
    var hour = timeDate.hour ?? 0;
    if ((hour >= 6 && hour < 18) || time == "") {
      ...
      return switch (weatherEnum) {
        WeatherTypeEnum.CLEAR_NIGHT => "images/N113.png",
        WeatherTypeEnum.PARTLY_CLOUDY => "images/N116.png",
        WeatherTypeEnum.CLOUDY => "images/N119.png",
        WeatherTypeEnum.OVERCAST => "images/N122.png",
        WeatherTypeEnum.MIST => "images/N143.png",
        WeatherTypeEnum.PATCHY_RAIN_POSSIBLE => "images/N176.png",
        WeatherTypeEnum.PATCHY_SNOW_POSSIBLE => "images/N179.png",
        WeatherTypeEnum.PATCHY_SLEET_POSSIBLE => "images/N182.png",
        WeatherTypeEnum.PATCHY_FREEZING_DRIZZLE_POSSIBLE => "images/N185.png",
        WeatherTypeEnum.THUNDERY_OUTBREAKS_POSSIBLE => "images/N200.png",
        WeatherTypeEnum.BLOWING_SNOW => "images/N227.png",
        WeatherTypeEnum.BLIZZARD => "images/N230.png",
        WeatherTypeEnum.FOG => "images/N248.png",
        WeatherTypeEnum.FREEZING_FOG => "images/N260.png",
        WeatherTypeEnum.PATCHY_LIGHT_DRIZZLE => "images/N263.png",
        WeatherTypeEnum.LIGHT_DRIZZLE => "images/N266.png",
        WeatherTypeEnum.FREEZING_DRIZZLE => "images/N281.png",
        WeatherTypeEnum.HEAVY_FREEZING_DRIZZLE => "images/N284.png",
        WeatherTypeEnum.PATCHY_LIGHT_RAIN => "images/N293.png",
        WeatherTypeEnum.LIGHT_RAIN => "images/N296.png",
        WeatherTypeEnum.MODERATE_RAIN_AT_TIMES => "images/N299.png",
        WeatherTypeEnum.MODERATE_RAIN => "images/N302.png",
        WeatherTypeEnum.HEAVY_RAIN_AT_TIMES => "images/N305.png",
        WeatherTypeEnum.HEAVY_RAIN => "images/N308.png",
        WeatherTypeEnum.LIGHT_FREEZING_RAIN => "images/N311.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_FREEZING_RAIN => "images/N314.png",
        WeatherTypeEnum.LIGHT_SLEET => "images/N317.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_SLEET => "images/N320.png",
        WeatherTypeEnum.PATCHY_LIGHT_SNOW => "images/N323.png",
        WeatherTypeEnum.LIGHT_SNOW => "images/N326.png",
        WeatherTypeEnum.PATCHY_MODERATE_SNOW => "images/N329.png",
        WeatherTypeEnum.MODERATE_SNOW => "images/N332.png",
        WeatherTypeEnum.PATCHY_HEAVY_SNOW => "images/N335.png",
        WeatherTypeEnum.HEAVY_SNOW => "images/N338.png",
        WeatherTypeEnum.ICE_PELLETS => "images/N350.png",
        WeatherTypeEnum.LIGHT_RAIN_SHOWER => "images/N353.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_RAIN_SHOWER => "images/N113.png",
        WeatherTypeEnum.TORRENTIAL_RAIN_SHOWER => "images/N356.png",
        WeatherTypeEnum.LIGHT_SLEET_SHOWER => "images/N362.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_SLEET_SHOWERS => "images/N365.png",
        WeatherTypeEnum.LIGHT_SNOW_SHOWERS => "images/N368.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_SNOW_SHOWERS => "images/N371.png",
        WeatherTypeEnum.LIGHT_SHOWERS_OF_ICE_PELLETS => "images/N374.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_SHOWERS_OF_ICE_PELLETS => "images/N377.png",
        WeatherTypeEnum.PATCH_LIGHT_RAIN_WITH_THUNDER => "images/N386.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_RAIN_WITH_THUNDER => "images/N389.png",
        WeatherTypeEnum.PATCH_LIGHT_SNOW_WITH_THUNDER => "images/N392.png",
        WeatherTypeEnum.MODERATE_OR_HEAVY_SNOW_WITH_THUNDER => "images/N395.png",
        _ => "images/N113.png"
      };
    }
